...
frontend_urlpatterns = [
    ...
    path('store/',         TemplateView.as_view(template_name='erp/store.html'),        name='store'),
    path('store/manage/',  TemplateView.as_view(template_name='erp/store_manage.html'), name='store_manage'),
    path('error-monitor/', TemplateView.as_view(template_name='erp/error_monitor.html'), name='error_monitor'),
